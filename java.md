...
### Database
+ [commons-dbutils](https://github.com/apache/commons-dbutils) - jdbc utility component
...
+ [swagger-core]( https://github.com/swagger-api/swagger-core) - 实例和服务器整合来产生Swagger API规范，用于使访问REST API更轻松
